...
Both ``scraper_builder.py`` and ``filter_qa.py`` route every human gate through this
one function (it is also exposed to the LLM as an ``ask_human`` tool). Like the rest
